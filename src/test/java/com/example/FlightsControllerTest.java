...
import com.example.FlightsController;
...
public class FlightsControllerTest {
    ...
    public void testGetFlight() throws Exception{
        ...
        this.mvc.perform(get("/flights/flight"))
                ...
                .andExpect(jsonPath("$.Tickets[0].Passenger.FirstName",is("Bittu")));
    }
    ...
    public void testComputeTicketsTotalV2() throws Exception {
        ...
        TicketService ticket1 = new TicketService();
        ticket1.setPrice(200);

        TicketService ticket2 = new TicketService();
        ticket2.setPrice(100);

        flight.setTicket(Arrays.asList(ticket2,ticket1));
